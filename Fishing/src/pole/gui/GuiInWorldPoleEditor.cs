...
public class GuiInWorldPoleEditor : Gui
{
    ...
    {
        AddWidget(new WidgetInWorldItemSlot([rodSlot[3]], 1, 1, 96, null, () =>
        {
            return ItemFishingRod.GetSwayedPosition(MainAPI.Capi.World.Player.Entity, 2f);
        }, "Catch", () =>
        {
        ...
        {
            return ItemFishingRod.GetSwayedPosition(MainAPI.Capi.World.Player.Entity, 1f);
        }, "Bobber", () =>
        {
            return rodSlot[0].Itemstack != null && rodSlot[3].Itemstack == null;
        }, false));
